<?php
session_start();
// O config.php fornece a BASE_URL necessária para a portabilidade
                        ...
                        <?php if (count($pedidos) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= BASE_URL ?>admin/excluir_pedido.php?id=<?= $ped['id'] ?>" 
                                       class="btn btn-outline-danger btn-sm" 
                                       onclick="return confirm('Confirmas que este pedido foi entregue/pago e pode ser removido do histórico?')">
