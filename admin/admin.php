<?php
session_start();
// O config.php garante que a BASE_URL está disponível
    ...
    <div class="container py-5">
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <a href="<?= BASE_URL ?>admin/adicionar_produto.php" class="btn btn-accent px-4 py-2 shadow-sm fw-bold">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="<?= BASE_URL ?>imgs/<?= $p['imagem'] ?>" class="img-admin me-3">
                            ...
                            <td class="text-center">
                                <a href="<?= BASE_URL ?>admin/editar.php?id=<?= $p['id'] ?>" class="btn btn-warning btn-sm me-2">
                                    <i class="fas fa-edit"></i> Editar
                                </a>
                                <a href="<?= BASE_URL ?>admin/excluir.php?id=<?= $p['id'] ?>" 
                                   class="btn btn-danger btn-sm" 
                                   onclick="return confirm('Tens a certeza que queres eliminar este hambúrguer?')">
