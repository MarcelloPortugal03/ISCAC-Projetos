            ...
            <div class="col-md-4">
                <div class="card p-4 shadow border-0 bg-dark text-white">
                    <div class="text-center mb-4">
                        <img src="../imgs/logo11.png" alt="logo" width="60">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a href="registo.php" class="text-accent text-decoration-none fw-bold">Criar conta gratuita</a>
                        <hr class="border-secondary">
                        <a href="../index.php" class="text-white-50 text-decoration-none small">← Voltar ao site</a>
                    </div>
                </div>
            </div>
        </div>
