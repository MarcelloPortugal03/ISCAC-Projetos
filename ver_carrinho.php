...
// SEGURANÇA CORRIGIDA: Se não houver login, manda para o login usando a BASE_URL
    ...
    <div class="container py-5">
        ...
        <?php if (!isset($_SESSION['carrinho']) || empty($_SESSION['carrinho'])): ?>
            <div class="text-center py-5 border border-secondary rounded bg-dark">
                ...
                <a href="<?= BASE_URL ?>menu.php" class="btn btn-outline-light">Ir ao Menu</a>
            </div>
        <?php else: ?>
            <div class="table-responsive bg-dark p-3 rounded shadow border border-secondary">
                <table class="table table-dark table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?= BASE_URL ?>carrinho.php?remover=<?= $id ?>" class="text-danger text-decoration-none small">Remover</a></td>
                        </tr>
                ...
                <div class="text-end mt-4">
                    ...
                    <a href="<?= BASE_URL ?>menu.php" class="btn btn-outline-secondary me-2">Continuar a Comprar</a>
                    <a href="<?= BASE_URL ?>finalizar.php" class="btn btn-accent btn-lg fw-bold">FINALIZAR PEDIDO</a>
                </div>
            </div>
        <?php endif; ?>
    </div>
