<?php 
session_start();
// O config.php é obrigatório para termos a nossa BASE_URL dinâmica
    ...
    <section class="container py-5">
        ...
        <div class="row align-items-center justify-content-center g-5">
            <div class="col-md-5 text-center">
                <img src="<?= BASE_URL ?>imgs/about.jpeg" class="img-fluid rounded-4 shadow-lg" alt="Sobre a ISCAC Burguer">
            </div>
            <div class="col-md-7">
                ...
                <a href="<?= BASE_URL ?>menu.php" class="btn btn-danger btn-lg px-5 shadow-sm fw-bold btn-menu-add">
                    Ver Menu Agora
                </a>
            </div>
        </div>
